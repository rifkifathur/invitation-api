...
@section('content')
    <div class="body flex-grow-1 px-3">
        <div class="container-lg">
            <a href="{{ route('create-theme') }}" class="btn btn-primary mb-4">Tambah data</a>
                    ...
                    @foreach ($data as $key => $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <span>
                                    <a href="{{ route('edit-theme', $item->id) }}" class="btn text-info">
                                        <svg class="nav-icon" width="18px" height="18px">
                                            <use
                                ...
                                <span>
                                    <form action="{{ route('destroy-theme', $item->id) }}" method="POST"
