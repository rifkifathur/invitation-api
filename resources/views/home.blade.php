                    ...
                    <div class="card mb-4 text-white bg-primary">
                        <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" style=""><a class="dropdown-item"
                        ...
                        <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                            ...
                            <div class="chartjs-tooltip" style="opacity: 0; left: 185.167px; top: 129.847px;">
                    ...
                    <div class="card mb-4 text-white bg-info">
                        ...
                        <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                            <canvas class="chart" id="card-chart2" height="70" width="207"
                                style="display: block; box-sizing: border-box; height: 70px; width: 207px;"></canvas>
                            <div class="chartjs-tooltip" style="opacity: 0; left: 21px; top: 142.125px;">
                                <table style="margin: 0px;">
                                    <thead class="chartjs-tooltip-header">
                                        <tr class="chartjs-tooltip-header-item" style="border-width: 0px;">
